...
def main(args):  
    ...
    for epoch in tqdm(range(start_epoch, args.epochs + 1), desc=args.congfig_name):     
        ...
        sort_idx = np.argsort(-sta2_sub_loss)
        ...
        Log.info('[Training Epoch:%3d/%3d] loss_bcd: %.4f loss_seg: %.4f loss_sta3: %.4f  | lr: %f/%f' % (epoch, args.epochs, losses_bcd.avg, losses_seg.avg, losses_total.avg, get_lr(optimizer_SEG), get_lr(optimizer_BCD))) 
